 ...
 *              If file_from does not exist or cannot be read - the exit code 98.
 *              If file_to cannot be created or written to - the exit code 99.
 *              If file_to or file_from cannot be closed - the exit code 100.
 */
